export const ORGANIZER = [
  ...
  },
  {
    ...
    comment: (
      <span>
        애플 생태계 안에서 해적선을 운영하는 캡틴 링고후크. 검은 코딩토끼를 본
  ...
  {
    name: "Atlas",
    image: "./resources/organizer/Atlas.png",
    comment: (
      <span>
        모니터 바깥 세상에서 커피 한 잔을 함께 즐길 수 있는 대화법을 연구하고
        있습니다!
        <br /> 커피 한 잔 어떠세요? ☕️
      </span>
    ),
  ...
  {
    name: "Noah",
    image: "./resources/organizer/Noah.png",
    comment: (
      <span>
        Live curiously! <br />
        호기심으로 더 성장하는 개발자가 되고 싶습니다:) 개발 이야기를 하는 것을
        가장 좋아합니다 :)
      </span>
    ),
  ...
  {
    name: "SongCool",
    image: "./resources/organizer/SongCool.png",
    comment: (
      <span>
        유저리서치, 제품디자인, 초록들과 조경에 관심이 많은 메이커
        SongCool입니다.
      </span>
    ),
  ...
  {
    name: "szzang",
    image: "./resources/organizer/szzang.png",
    comment: (
      <span>
  ...
  },
  {
    ...
    comment: (
      <span>
        iOS 커뮤니티에 도움을 받아 성장하고 지금은 커뮤니티에 도움을 돌려주고
  ...
  {
    name: "황지희 (Jee.e)",
    image: "./resources/organizer/황지희.png",
    comment: (
      <span>
        빠른 길보다 바른 길을 가는, 꾸준함의 힘과 도전의 가치를 아는
        디발자입니다 :D
      </span>
    ),
  ...
  {
    name: "Dora",
    image: "./resources/organizer/Dora.png",
    comment: (
      <span>
  ...
  {
    name: "Sujin Lee",
    image: "./resources/organizer/SujinLee.png",
    comment: (
      <span>
        HIG 톺아보기가 취미입니다. 스티브 잡스의 ‘사람과 아이디어는 마찰과
        소음을 통해 아름답게 빛나게 된다’는 말을 좋아합니다. 이전에는 PM으로
        일했고, 현재는 IT업계를 지망하는 분들에게 IT업계 Business 직무의 재미를
        전파하고 있습니다.
      </span>
    ),
