                ...
                <div class="content">
                  ...
                  <div class="sub-content">
                    ...
                    <div class="sub-content-body">
                      <ul>
                        <li>
                          후원사는 행사 후원 의사를 밝힌 후 커뮤니티 연합의 승인을
                          통지받은 날로부터 14일 이내에 후원 신청 금액을 커뮤니티연합이
                          정한 계좌에 일시불로 지급해야 합니다. <br />
                          단, 후원사가 지급 기한 연장에 대한 정당한 사유를 들어 연장을
                          신청한 경우 커뮤니티 연합은 해당 신청을 승인할 수 있습니다.
                        </li>
                        <li>
                          커뮤니티연합이 승인을 통지한 날 해당 후원 등급의 잔여 구좌가
                          감소됩니다. <br />
                          입금 기한이 지나 신청이 취소된 경우 잔여 구좌가 다시
                          증가됩니다.
                        </li>
                        <li>
                          후원금 지급 최종 기한 및 후원 서비스 공급의 최종 서약 기한은
                          6월 18일 이며 제1항에 따른 연장 신청이 승인된 경우에도 이와
                          같습니다.
                        </li>
                      </ul>
                    </div>
                  ...
                  <div class="sub-content">
                    ...
                    <div class="sub-content-body">
                      <ul>
                        <li>
                          후원 금액 및 후원 서비스에 따른 후원 등급 및 각 후원 등급별
                          후원사에 대한 커뮤니티연합의 의무는 행사 홈페이지에 안내된
                          바와 같습니다.
                          <br />
                          <br />
                          단, 양 당사자의 합의에 따라 특약으로 행사 홈페이지에 안내된
                          내용과 다르게 약관을 작성할 수 있습니다.
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="sub-content">
                    ...
                    <div class="sub-content-body">
                      <ul>
                        <li>
                          후원사는 커뮤니티연합에게 다음 각 호의 기간에 따른 위약금을
                          지급하고 후원 계약을 해지할 수 있으며, 이미 후원금을 지급한
                          경우 커뮤니티연합은 위약금을 제외한 후원금을 반환합니다.
                          <br />
                          <br />
                          단, 후원 금액 중 일부를 취소하는 경우 취소를 요청한 금액에
                          다음 각 호에 따른 위약금 산정 비율이 적용됩니다. <br />
                          후원 서비스 제공의 경우, 후원사의 상용 서비스의 금액을
                          기준으로 후원 금액을 산정하여 적용합니다.
                        </li>
                      </ul>
                  ...
                  <div class="sub-content">
                    ...
                    <div class="sub-content-body">
                      <ul>
                        <li>
                          커뮤니티연합이 행사를 연기하는 경우(연기 기한은 9월 18일까지로
                          합니다) 연기된 행사일 날짜를 기준으로 후원 계약의 내용이
                          변경됩니다. <br />
                          이 경우 후원사는 후원 계약을 해지하거나 후원 금액 중 일부를
                          취소할 수 있으나, 연기된 행사일 날짜를 기준으로 제4조 각호의
                          기간을 적용하여 위약금 산정비율이 적용됩니다.
                        </li>
                      </ul>
                    </div>
                  </div>
